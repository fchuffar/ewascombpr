...
dm_regions = annotatr::read_regions(con=results_filename, genome = 'hg38', format = 'bed')
# Build the annotations (a single GRanges object)
if (! exists("annotations")) {
  annots = c("hg38_lncrna_gencode")
  annots = c('hg38_cpgs', 'hg38_basicgenes', "hg38_lncrna_gencode", "hg38_enhancers_fantom")
...
# dedup
df_dm_annotated$annot.type = factor(df_dm_annotated$annot.type, levels=c("hg38_genes_promoters", "hg38_genes_1to5kb", "hg38_genes_5UTRs", "hg38_genes_exons", "hg38_genes_introns", "hg38_genes_3UTRs"))
