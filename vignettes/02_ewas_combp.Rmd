...
FILTER_EWAS_FOR_DMR_CANDIDATE = TRUE
if (FILTER_EWAS_FOR_DMR_CANDIDATE) {
  # source("~/projects/expedition_5300/results/meth/common.R") ; build_dmr_candidates(pf_orig=pf, pf_chr_colname="seqnames", pf_pos_colname="start")
