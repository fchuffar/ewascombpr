...
dm_regions = annotatr::read_regions(con=results_filename, genome = 'hg19', format = 'bed')
# Build the annotations (a single GRanges object)
if (! exists("annotations")) {
  annots = c("hg19_lncrna_gencode")
  annots = c('hg19_cpgs', 'hg19_basicgenes', "hg19_lncrna_gencode", "hg19_enhancers_fantom")
...
# dedup
df_dm_annotated$annot.type = factor(df_dm_annotated$annot.type, levels=c("hg19_genes_promoters", "hg19_genes_1to5kb", "hg19_genes_5UTRs", "hg19_genes_exons", "hg19_genes_introns", "hg19_genes_3UTRs"))
