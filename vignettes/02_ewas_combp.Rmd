...
The main objective of this study is to explore the difference in methylation between two groups of breast cancer: GEC+ versus GEC-. We aim to identify the differentially methylated sites, the differentially methylated regions (DMR) as well as the corresponding genes.


# Data

We use the methylation data provided by the TCGA public repository.

Dataset: `r study_filename`

Technology: (Illumina?) bead chip containing (how many?) methylation sites with annotations.
